...
class Meal {
  ...
  // print out
  void printOut(){
    println("duration: "+ duration + ", yummy: " + yummy + ", healthy: " + healthy + ", ingredients: " + ingredients);
  }
}

// duration comparator, follow the structure, and use is as an add-on to your object class
class MealDurationComparator implements Comparator<Meal>{
  @Override
